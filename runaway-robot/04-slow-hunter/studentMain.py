...
def next_move(hunter_position, hunter_heading, target_measurement, max_distance, OTHER=None):
    ...
    # project targets position 2 additional time steps out and move there
        ...
        target_position2, model_data2 = estimate_next_pos(target_position, model_data)
        target_position3, model_data3 = estimate_next_pos(target_position2, model_data2)
        distance = min(max_distance, distance_between(hunter_position, target_position3))
        turning = get_heading(hunter_position, target_position3) - hunter_heading
